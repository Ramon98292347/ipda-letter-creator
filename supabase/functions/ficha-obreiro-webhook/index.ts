...
function buildHtmlData(
  ...
  return {
    ...
    ano4: toText(dados.historico_gestao_4_ano),
    ipda4: toText(dados.historico_gestao_4_ipda),
    uf_igreja4: toText(dados.historico_gestao_4_uf).toUpperCase(),
    tempo4: toText(dados.historico_gestao_4_tempo),
    ano5: toText(dados.historico_gestao_5_ano),
    ipda5: toText(dados.historico_gestao_5_ipda),
    uf_igreja5: toText(dados.historico_gestao_5_uf).toUpperCase(),
    tempo5: toText(dados.historico_gestao_5_tempo),
    ano6: toText(dados.historico_gestao_6_ano),
    ipda6: toText(dados.historico_gestao_6_ipda),
    uf_igreja6: toText(dados.historico_gestao_6_uf).toUpperCase(),
    tempo6: toText(dados.historico_gestao_6_tempo),
