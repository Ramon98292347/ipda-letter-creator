...
const CODE_MAP: Record<string, string> = {
  ...
  meeting_not_found: "Essa reuniao nao foi encontrada.",
  meeting_inactive: "Essa lista de presenca foi desativada.",
  meeting_expired: "Essa lista de presenca expirou.",
  invalid_expires_at: "Informe uma validade correta para o link da reuniao.",
  meeting_date_in_past: "A data da reuniao nao pode estar no passado.",
  db_error_create_meeting: "Nao foi possivel criar a reuniao ministerial.",
  db_error_update_meeting: "Nao foi possivel atualizar a reuniao ministerial.",
  db_error_meetings: "Nao foi possivel listar as reunioes ministeriais.",
