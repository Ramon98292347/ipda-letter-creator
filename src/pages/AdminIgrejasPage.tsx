    ...
    <ManagementShell roleMode="admin">
      <div className="space-y-5 bg-[#F6F8FC] p-1">
        ...
        <section className="grid gap-4 md:grid-cols-3 xl:grid-cols-6">
          <IgrejaStat title="Total" value={totals.total} subtitle="igrejas no escopo" tone={tone.total} />
          <IgrejaStat title="Estadual" value={totals.estadual} subtitle="classe estadual" tone={tone.estadual} />
          <IgrejaStat title="Setorial" value={totals.setorial} subtitle="classe setorial" tone={tone.setorial} />
          <IgrejaStat title="Central" value={totals.central} subtitle="classe central" tone={tone.central} />
          <IgrejaStat title="Regional" value={totals.regional} subtitle="classe regional" tone={tone.regional} />
          <IgrejaStat title="Local" value={totals.local} subtitle="classe local" tone={tone.local} />
        </section>
